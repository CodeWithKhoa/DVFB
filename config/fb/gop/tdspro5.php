...
while (true) {
    if (file_exists("Cookiefb.txt")) {
        ...
        echo $thanh_dep . $luc . "Nhập " . $vang . "[" . $trang . "1" . $vang . "] " . $luc . "Giữ Lại Cookie Pro5 Cũ\n";
    ...
    if (!file_exists("Cookiefb.txt")) {
        ...
        for ($a = 1; $a < 999999; $a++) {
            echo $daucau2 . $luc . "Nhập Cookie Pro5 Thứ $a: $vang";
            $nhapck = trim(fgets(STDIN));
            if ($nhapck == '') {
                $nhapCookie = true; // Đánh dấu đã nhập cookie
                break;
            }
            $ttck = json_decode(dvfb('thongtin',null,null,$nhapck),true);
            if ($ttck['status']=='success') {
                echo $ttck['message']['name'] . " | " . $ttck['message']['id'] . " \n";
                    ...
                    if ($x != "") {
                        ...
                        while (true) {
                            ...
                            if ($id < '1') {
                                ...
                                $d += 1;
                                echo "\033[1;37m".$id."                             \r";
                                $g = json_decode(dvfb("likepro5",$id,null,$cookie),true);
                                if ($g["status"]=="error") 
                                {
                    ...
                    if ($x != "") {
                        ...
                        while (true) {
                            ...
                            if ($id < '1') {
                                ...
                                $d += 1;
                                echo "\033[1;37m".$id."                             \r";
                                $g = json_decode(dvfb("followpro5",$id,null,$cookie));
                                if ($g["status"]=="error") 
                                {
                                    if($g["message"]=="Bạn đã bị block !!!"){
                                        echo "                                                      \r";
                    ...
                    if ($x != "") {
                        ...
                        while (true) {
                            ...
                            if ($id < '1') {
                                ...
                                $d += 1;
                                echo "\033[1;37m".$id."                             \r";
                                $g = json_decode(dvfb($type."CMTPRO5",$id,null,$cookie),true);
                                if ($g["status"]=="error") 
                                {
                                    if($g["message"]=="Bạn đã bị block !!!"){
                                        echo "                                                      \r";
                    ...
                    if ($x != "") {
                        ...
                        while (true) {
                            ...
                            if ($id < '1') {
                                ...
                                $d += 1;
                                echo "\033[1;37m".$id."                             \r";
                                $g = json_decode(dvfb("likepagepro5",$id,null,$cookie),true);
                                if ($g["status"]=="error") 
                                {
                                    if($g["message"]=="Bạn đã bị block !!!"){
                                        echo "                                                      \r";
                    ...
                    if ($x != "") {
                        ...
                        while (true) {
                            ...
                            if ($id < '1') {
                                ...
                                $d += 1;
                                echo "\033[1;37m".$id."                             \r";
                                $g = json_decode(dvfb("sharepro5",$id,null,$cookie),true);
                                if ($g["status"]=="error") 
                                {
                                    if($g["message"]=="Bạn đã bị block !!!"){
                                        echo "                                                      \r";
                    ...
                    if ($x != "") {
                        ...
                        while (true) {
                            ...
                            if ($id < '1') {
                                ...
                                $d += 1;
                                echo "\033[1;37m".$id."                             \r";
                                $g = json_decode(dvfb($type."PRO5",$id,null,$cookie),true);
                                if ($g["status"]=="error") 
                                {
                                    if($g["message"]=="Bạn đã bị block !!!"){
                                        echo "                                                      \r";
                    ...
                    if ($x != "") {
                        ...
                        while (true) {
                            ...
                            if ($id < '1') {
                                ...
                                $d += 1;
                                echo "\033[1;37m".$id."                             \r";
                                $g = json_decode(dvfb("commentpro5",$id,$msg,$cookie),true);
                                if ($g["status"]=="error") 
                                {
                                    if($g["message"]=="Bạn đã bị block !!!"){
                                        echo "                                                      \r";
                    ...
                    if ($x != "") {
                        ...
                        while (true) {
                            ...
                            if ($id < '1') {
                                ...
                                $d += 1;
                                echo "\033[1;37m".$id."                            \r";
                                $g = json_decode(dvfb("joingrouppro5",$id,null,$cookie),true);
                                if ($g["status"]=="error") 
                                {
                                    if($g["message"]=="Bạn đã bị block !!!"){
                                        echo "                                                      \r";
